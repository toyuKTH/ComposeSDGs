...
- The current interface is driven by **fake / placeholder data** so that the sonification, staff display, and UI flow can be tested.
...
What we do with Web Audio API right now:
